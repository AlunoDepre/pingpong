class Cpu{
    constructor(c, bolinha){
        ...
        this.raquete1 = new Image ();
        this.raquete1.width = 20;
        this.raquete1.height = 100;
        this.raquete1.src = "assests/raquete1.jpg";
        this.raquete1.addEventListener('load', () => {
            this.draw()
        });
    ...
    draw(){
        ...
        this.c.drawImage(this.raquete1, this.x, this.y, this.raquete1.width, this.raquete1.height);
    }
}